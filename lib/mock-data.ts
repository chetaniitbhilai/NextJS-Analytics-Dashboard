...
export const generateTableData = (): TableRow[] => {
  const campaigns = [
    'Summer Sale Campaign', 'Black Friday Blast', 'Product Launch', 'Brand Awareness',
    'Retargeting Campaign', 'Holiday Special', 'New Customer Acquisition', 'Customer Retention',
    'Flash Sale Event', 'Newsletter Signup', 'App Install Campaign', 'Video Ad Campaign'
  ];
